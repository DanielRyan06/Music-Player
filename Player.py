...
player.geometry("450x270")

var = tkinter.StringVar()
var.set("Select a song")

os.chdir(askdirectory())
songlist = os.listdir()

playing = tkinter.Listbox(player,font="Helvetica 12 bold",width=50,bg="black",fg="white",selectmode=tkinter.SINGLE)
...
def play():
    ...
    var.set(f"{name[:16]}..." if len(name)>30 else name)
